-- ============================================================================
-- MATH4CODE DATABASE FUNCTIONS & RPCs
-- File: 02_functions_rpc.sql (Business Logic)
-- ============================================================================
-- This file contains all PostgreSQL functions and Remote Procedure Calls
-- Execute this file AFTER running 01_schema.sql
-- All statements are idempotent (safe to run multiple times)
-- ============================================================================

-- ============================================================================
-- AUTH FUNCTION: HANDLE NEW USER REGISTRATION
-- ============================================================================
...
-- ============================================================================
-- EXAM SUBMISSION RPC (CRITICAL FUNCTION)
-- ============================================================================
            ...
            (
                CASE 
                    ...
                    WHEN q.question_type = 'NAT' THEN 
                        -- CRITICAL FIX: Cast student_answer to numeric for NAT questions
...
BEGIN
    ...
    next_exams AS (
        ...
        ORDER BY tse.test_series_id, e.created_at ASC
    )
    SELECT 
        ts.id,
        ts.title,
