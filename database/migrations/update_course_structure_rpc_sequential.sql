-- ============================================================
-- UPDATE get_course_structure RPC - Add Sequential Learning Fields
-- ============================================================
-- Purpose: Include sequential_unlock_enabled and prerequisite_lesson_id
-- for sequential learning feature
-- ============================================================
            ...
            'lessons', (
                SELECT COALESCE(json_agg(
                    json_build_object(
                        ...
                        'sequential_unlock_enabled', COALESCE(l.sequential_unlock_enabled, false),
                        'prerequisite_lesson_id', l.prerequisite_lesson_id,
                        'created_at', l.created_at,
                        'updated_at', l.updated_at,
                        -- Exam Details for Badges
                        'exam_details', (
