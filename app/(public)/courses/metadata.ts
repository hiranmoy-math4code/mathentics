...
export const metadata: Metadata = {
    ...
    keywords: ['online courses', 'mathematics courses', 'IIT JAM preparation', 'CSIR NET courses', 'GATE mathematics', 'competitive exam preparation', 'video lectures'],
    openGraph: {
        title: 'Online Courses - Mathematics & Exam Prep | mathentics',
        description: 'Browse expert-led courses for IIT-JAM, CSIR NET, GATE and more. Join 1000+ students learning mathematics online.',
        type: 'website',
        url: 'https://www.mathentics.com/courses',
    },
    twitter: {
