...
export default function TermsOfUsePage() {
    return (
        <div className="container mx-auto px-4 py-12 pt-32 max-w-4xl">
            <h1 className="text-4xl font-extrabold mb-8 text-slate-900 tracking-tight">Terms of Use</h1>
            ...
            <div className="prose prose-slate prose-lg max-w-none text-slate-600 space-y-12">
                ...
                <section>
                    <h2 className="text-2xl font-bold text-slate-900 mb-6 border-b pb-2">Access and Registration</h2>
                    <div className="space-y-4">
                        ...
                        <p>
                            For the purpose of this Agreement, <span className="font-bold">“Content”</span> shall mean and include any course or session (whether pre-recorded or live) published by the Creator on the Platform, including, but not limited to any reference materials and text files (if any) offered to You as part of the Content.
                        </p>
                        <p>
                            When You register or enrol for any Content on the Platform, You may also have access to discussion forums that enables You to exchange Your thoughts, knowledge in relation to the Content or its subject-matter, with us and other registrants to the Content (<span className="font-bold">“Public Forum”</span>). Participating in the Public Forum is completely Your choice and by registering or enrolling to a Content on the Platform, You are not obligated to participate in such Public Forum.
                        </p>
                        <p>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-slate-900 mb-6 border-b pb-2">Communications</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-slate-900 mb-6 border-b pb-2">Code of Conduct</h2>
                    <div className="space-y-6">
                        <div>
                            <h3 className="text-xl font-bold text-slate-800 mb-2">Legitimate usage of the Platform</h3>
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-slate-800 mb-2">No harmful or dangerous content</h3>
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-slate-800 mb-2">No hateful or defamatory content</h3>
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-slate-800 mb-2">Violent and graphic content</h3>
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-slate-800 mb-2">Harassment and bullying</h3>
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-slate-800 mb-2">Spam</h3>
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-slate-800 mb-2">Scams</h3>
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-slate-800 mb-2">Privacy violation</h3>
                            <p>Kindly refer to our Privacy Policy to know how to protect Your privacy and respect the privacy of other Users.</p>
                        </div>
                        <div>
                            <h3 className="text-xl font-bold text-slate-800 mb-2">Impersonation</h3>
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-slate-800 mb-2">Unauthorized Access or Disabling of Platform</h3>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-slate-900 mb-6 border-b pb-2">Intellectual Property</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-slate-900 mb-6 border-b pb-2">Feedback</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-slate-900 mb-6 border-b pb-2">Payments and Refunds</h2>
                    <p>
                ...
                <section className="bg-slate-50 p-8 rounded-3xl border border-slate-100 italic">
                    <h2 className="text-2xl font-bold text-slate-900 mb-6 not-italic">Disclaimer</h2>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-slate-900 mb-6 border-b pb-2">Limitation of Liability</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-slate-900 mb-6 border-b pb-2">Indemnity and Release</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-slate-900 mb-6 border-b pb-2">Links to Third Party Website</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-slate-900 mb-6 border-b pb-2">Governing Law and Jurisdiction</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-slate-900 mb-6 border-b pb-2">Miscellaneous</h2>
                    <div className="space-y-4">
                        <p><span className="font-bold">Alteration of Platform or Amendments to the Conditions:</span> We reserve the right to make changes to our Platform, policies, and this Agreement at any time. We will post the new terms with a revision date indicated at the top or if deemed practicable. You should check our Platform frequently to see recent changes. You will be subject to the Agreement and the policies in force at the time that You use the Platform or any part thereof, unless any change to those policies or these conditions is required to be made by law or government authority (in which case it will apply to orders previously placed by You). If any of these conditions is deemed invalid, void, or for any reason unenforceable, that condition will be deemed severable and will not affect the validity and enforceability of any remaining condition.</p>
                        <p><span className="font-bold">Waiver:</span> If You breach these conditions and we take no action, we will still be entitled to use our rights and remedies in any other situation where You breach these conditions.</p>
                        <p><span className="font-bold">Assignment:</span> You may not assign or transfer this Agreement, by operation or law or otherwise. Any attempt by You to assign or transfer this Agreement will be null and void.</p>
                        <p><span className="font-bold">Severability:</span> If any provision of this Agreement will be adjudged by any court of competent jurisdiction to be unenforceable or invalid, that provision will be limited to the minimum extent necessary so that this Agreement will otherwise remain in effect.</p>
                        <p><span className="font-bold">Events beyond our reasonable control:</span> We will not be held responsible for any delay or failure to comply with our obligations under these conditions if the delay or failure arises from any cause which is beyond our reasonable control. This condition does not affect Your statutory rights.</p>
                    </div>
                </section>
