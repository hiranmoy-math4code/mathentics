(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/ssr/[root-of-the-server]__88dd943e._.js",
...
"[project]/actions/admin/updateCourseMetadata.ts [app-edge-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"402326abcfefce03fb481db7d25c209611796d2693":"uploadCourseThumbnail","40419743c231098c18ce34a433d440e503b8c3c524":"deleteCourseThumbnail","4089a9078cb64133e3e1245dbbd42099372533737c":"updateCourseMetadata"},"",""] */ __turbopack_context__.s([
...
;
;
async function updateCourseMetadata(data) {
    try {
        const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
        ...
        // Update course
        const { data: course, error } = await supabase.from('courses').update(updateData).eq('id', data.courseId).select().single();
        if (error) {
            console.error('Course update error:', error);
            throw new Error(`Failed to update course: ${error.message}`);
        }
        // Revalidate relevant paths
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/admin/courses');
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])(`/admin/courses/${data.courseId}`);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])(`/admin/courses/${data.courseId}/builder`);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])(`/courses/${data.courseId}`);
        return {
            success: true,
            data: course
        };
        ...
        return {
            error: error?.message || 'Failed to update course metadata'
        };
    }
}
async function uploadCourseThumbnail(data) {
    try {
        const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
        // Check authentication
        const { data: { user } } = await supabase.auth.getUser();
        ...
        const { data: course } = await supabase.from('courses').select('thumbnail_url').eq('id', data.courseId).single();
        // Delete old thumbnail if exists
        if (course?.thumbnail_url) {
            const oldPath = course.thumbnail_url.split('/').pop();
            if (oldPath) {
                await supabase.storage.from('course-thumbnails').remove([
                    `${data.courseId}/${oldPath}`
                ]);
            }
        }
        ...
        const { data: uploadData, error: uploadError } = await supabase.storage.from('course-thumbnails').upload(filePath, data.file, {
            cacheControl: '3600',
            upsert: false
        });
        if (uploadError) {
...
async function deleteCourseThumbnail(courseId) {
    try {
        const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
        // Check authentication
        const { data: { user } } = await supabase.auth.getUser();
        ...
        // Revalidate relevant paths
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/admin/courses');
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])(`/admin/courses/${courseId}`);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])(`/admin/courses/${courseId}/builder`);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])(`/courses/${courseId}`);
        return {
            success: true
        };
    } catch (error) {
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$server$2d$dom$2d$turbopack$2f$server$2e$edge$2e$js__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updateCourseMetadata, "4089a9078cb64133e3e1245dbbd42099372533737c", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$server$2d$dom$2d$turbopack$2f$server$2e$edge$2e$js__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(uploadCourseThumbnail, "402326abcfefce03fb481db7d25c209611796d2693", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$server$2d$dom$2d$turbopack$2f$server$2e$edge$2e$js__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteCourseThumbnail, "40419743c231098c18ce34a433d440e503b8c3c524", null);
}),
"[project]/.next-internal/server/app/admin/courses/[courseId]/builder/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/actions/rewardActions.ts [app-edge-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/actions/admin/students.ts [app-edge-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/actions/admin/grantAccess.ts [app-edge-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/actions/admin/updateCourseMetadata.ts [app-edge-rsc] (ecmascript)\" } [app-edge-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$admin$2f$updateCourseMetadata$2e$ts__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/actions/admin/updateCourseMetadata.ts [app-edge-rsc] (ecmascript)");
;
;
;
;
...
"[project]/.next-internal/server/app/admin/courses/[courseId]/builder/page/actions.js { ACTIONS_MODULE0 => \"[project]/app/actions/rewardActions.ts [app-edge-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/actions/admin/students.ts [app-edge-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/actions/admin/grantAccess.ts [app-edge-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/actions/admin/updateCourseMetadata.ts [app-edge-rsc] (ecmascript)\" } [app-edge-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "402326abcfefce03fb481db7d25c209611796d2693",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$admin$2f$updateCourseMetadata$2e$ts__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__["uploadCourseThumbnail"],
    "40419743c231098c18ce34a433d440e503b8c3c524",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$admin$2f$updateCourseMetadata$2e$ts__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__["deleteCourseThumbnail"],
    ...
    "4089a9078cb64133e3e1245dbbd42099372533737c",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$admin$2f$updateCourseMetadata$2e$ts__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__["updateCourseMetadata"],
...
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$admin$2f$courses$2f5b$courseId$5d2f$builder$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$app$2f$actions$2f$rewardActions$2e$ts__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$actions$2f$admin$2f$students$2e$ts__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE2__$3d3e$__$225b$project$5d2f$actions$2f$admin$2f$grantAccess$2e$ts__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE3__$3d3e$__$225b$project$5d2f$actions$2f$admin$2f$updateCourseMetadata$2e$ts__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$edge$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/admin/courses/[courseId]/builder/page/actions.js { ACTIONS_MODULE0 => "[project]/app/actions/rewardActions.ts [app-edge-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/actions/admin/students.ts [app-edge-rsc] (ecmascript)", ACTIONS_MODULE2 => "[project]/actions/admin/grantAccess.ts [app-edge-rsc] (ecmascript)", ACTIONS_MODULE3 => "[project]/actions/admin/updateCourseMetadata.ts [app-edge-rsc] (ecmascript)" } [app-edge-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$rewardActions$2e$ts__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/actions/rewardActions.ts [app-edge-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$admin$2f$students$2e$ts__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/actions/admin/students.ts [app-edge-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$admin$2f$grantAccess$2e$ts__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/actions/admin/grantAccess.ts [app-edge-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$actions$2f$admin$2f$updateCourseMetadata$2e$ts__$5b$app$2d$edge$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/actions/admin/updateCourseMetadata.ts [app-edge-rsc] (ecmascript)");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__88dd943e._.js.map