...
async function fetchCourses(userId) {
    const { data } = await supabase.from("courses").select("*").eq("creator_id", userId).eq("course_type", "course").order("created_at", {
        ascending: false
    });
    return data || [];
}
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CoursesPage.useEffect": ()=>{
            supabase.auth.getUser().then({
                "CoursesPage.useEffect": ({ data })=>setUserId(data.user?.id || null)
            }["CoursesPage.useEffect"]);
        }
    }["CoursesPage.useEffect"], []);
    const { data: courses, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "admin-courses",
            userId
        ],
        queryFn: {
            "CoursesPage.useQuery": ()=>fetchCourses(userId)
        }["CoursesPage.useQuery"],
        enabled: !!userId
    });
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Manage your curriculum, track learners, and publish content."
                    }, void 0, false, {
                        fileName: "[project]/app/admin/courses/page.tsx",
                        lineNumber: 39,
                        columnNumber: 17
...
_s(CoursesPage, "ndYZNB9GJFnf5NFY56R1sSoTs9Y=", false, function() {
    return [
...
"[project]/app/admin/courses/page.tsx [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/app/admin/courses/page.tsx [app-client] (ecmascript)"));
}),
]);

//# sourceMappingURL=_c8a5ea41._.js.map