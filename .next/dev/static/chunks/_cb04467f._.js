...
"[project]/hooks/student/useLessonProgress.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useMarkLessonComplete() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useMarkLessonComplete.useMutation": async ({ userId, lessonId, courseId })=>{
        ...
        }["useMarkLessonComplete.useMutation"],
        onMutate: {
            "useMarkLessonComplete.useMutation": async (variables)=>{
                ...
                queryClient.setQueryData([
                    ...
                    "useMarkLessonComplete.useMutation": (old)=>{
                        if (!old) return old;
                        const existing = old.find({
                            "useMarkLessonComplete.useMutation.existing": (p)=>p.lesson_id === variables.lessonId
                        }["useMarkLessonComplete.useMutation.existing"]);
                        if (existing) {
                            return old.map({
                                "useMarkLessonComplete.useMutation": (p)=>p.lesson_id === variables.lessonId ? {
                                        ...p,
                                        completed: true,
                                        completed_at: new Date().toISOString()
                                    } : p
                ...
                queryClient.setQueryData([
                    ...
                    "useMarkLessonComplete.useMutation": (old)=>{
                        if (!old) return old;
                        return old.map({
                            "useMarkLessonComplete.useMutation": (course)=>{
        ...
        onError: {
            "useMarkLessonComplete.useMutation": (err, variables, context)=>{
                // Rollback on error
        ...
        onSuccess: {
            "useMarkLessonComplete.useMutation": (_, variables)=>{
...
_s(useMarkLessonComplete, "YK0wzM21ECnncaq5SECwU+/SVdQ=", false, function() {
    return [
...
function useMarkLessonIncomplete() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "useMarkLessonIncomplete.useMutation": async ({ userId, lessonId, courseId })=>{
                const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
        ...
        }["useMarkLessonIncomplete.useMutation"],
        onMutate: {
            "useMarkLessonIncomplete.useMutation": async (variables)=>{
                // Cancel outgoing refetches
                await queryClient.cancelQueries({
                    queryKey: [
                        "student-courses",
                ...
                queryClient.setQueryData([
                    ...
                    "useMarkLessonIncomplete.useMutation": (old)=>{
                        if (!old) return old;
                        return old.map({
                            "useMarkLessonIncomplete.useMutation": (p)=>p.lesson_id === variables.lessonId ? {
                                    ...p,
                                    completed: false,
                                    completed_at: null
                                } : p
                ...
                queryClient.setQueryData([
                    ...
                    "useMarkLessonIncomplete.useMutation": (old)=>{
                        if (!old) return old;
                        return old.map({
                            "useMarkLessonIncomplete.useMutation": (course)=>{
                                if (course.id === variables.courseId) {
        ...
        onError: {
            "useMarkLessonIncomplete.useMutation": (err, variables, context)=>{
                // Rollback on error
                if (context?.previousCourses) {
                    queryClient.setQueryData([
                        "student-courses",
        ...
        onSuccess: {
            "useMarkLessonIncomplete.useMutation": (_, variables)=>{
                // Invalidate relevant queries to get accurate server data
                queryClient.invalidateQueries({
                    queryKey: [
                        "student-courses",
...
_s1(useMarkLessonIncomplete, "YK0wzM21ECnncaq5SECwU+/SVdQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"]
    ];
...
function useLessonProgress(userId, courseId) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useLessonProgress.useQuery": async ()=>{
        ...
        }["useLessonProgress.useQuery"],
        enabled: !!userId && !!courseId
    });
}
_s2(useLessonProgress, "4ZpngI1uv+Uo3WQHEZmTQ5FNM+k=", false, function() {
    return [
...
"[project]/hooks/useCourse.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useCourse = (courseId)=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useCourse.useQuery": async ({ signal })=>{
...
"[project]/hooks/useLessons.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useLessons = (courseId)=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useLessons.useQuery": async ({ signal })=>{
                ...
                if (error) {
                    ...
                    return fallbackData?.map({
                        "useLessons.useQuery": (module)=>({
                                ...module,
                                lessons: (module.lessons || []).sort({
                                    "useLessons.useQuery": (a, b)=>a.lesson_order - b.lesson_order
                                }["useLessons.useQuery"])
                            })
                    }["useLessons.useQuery"]);
                }
...
_s(useLessons, "4ZpngI1uv+Uo3WQHEZmTQ5FNM+k=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"]
    ];
});
...
"[project]/components/ClientSideLink.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ClientSideLink({ href, lessonId, onClick, className, children }) {
    ...
    const handleClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ClientSideLink.useCallback[handleClick]": (e)=>{
            e.preventDefault();
            // Call custom onClick if provided
            if (onClick) onClick();
            // Use global navigation function for instant transition
            if (("TURBOPACK compile-time value", "object") !== 'undefined' && window.__navigateToLesson) {
                window.__navigateToLesson(lessonId);
            } else {
                // Fallback to regular navigation
                window.location.href = href;
            }
        }
    }["ClientSideLink.useCallback[handleClick]"], [
        lessonId,
        href,
        onClick
    ]);
...
_s(ClientSideLink, "PRIOWs9bezaAbp8UlGmbaZMoYYA=");
_c = ClientSideLink;
var _c;
__turbopack_context__.k.register(_c, "ClientSideLink");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/LessonNavigation.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ClientSideLink$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ClientSideLink.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/utils.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
...
function LessonNavigation({ courseId, currentLessonId, prevLessonId, nextLessonId, variant = "default" }) {
    ...
    const { data: lessonProgress } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$student$2f$useLessonProgress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLessonProgress"])(userId || undefined, courseId);
    const { mutate: markComplete, isPending: isMarkingComplete } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$student$2f$useLessonProgress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMarkLessonComplete"])();
    const { mutate: markIncomplete, isPending: isMarkingIncomplete } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$student$2f$useLessonProgress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMarkLessonIncomplete"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LessonNavigation.useEffect": ()=>{
            const getUser = {
                "LessonNavigation.useEffect.getUser": async ()=>{
                    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
                    const { data: { user } } = await supabase.auth.getUser();
                    if (user) setUserId(user.id);
                }
            }["LessonNavigation.useEffect.getUser"];
            getUser();
        }
    }["LessonNavigation.useEffect"], []);
    ...
    const handleToggleComplete = ()=>{
        ...
        if (isCompleted) {
            markIncomplete({
                ...
                onSuccess: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Marked incomplete"),
                onError: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to update")
            });
        } else {
            markComplete({
                userId,
                ...
                onSuccess: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Marked complete! 🎉"),
                onError: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to update")
            });
        }
    };
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                    ...
                    children: prevLessonId ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ClientSideLink$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClientSideLink"], {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                    variant: "outline",
                    size: "sm",
                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("h-9 w-9 p-0 flex-shrink-0 md:w-auto md:px-4 md:h-9 gap-2 border-2 transition-all rounded-md", isCompleted ? "border-emerald-500/20 bg-emerald-50/10" : "border-muted-foreground/10"),
...
_s(LessonNavigation, "g0g0Pon3a1Y8VNqUA0Z7lv5FzEY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$student$2f$useLessonProgress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLessonProgress"],
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$student$2f$useLessonProgress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMarkLessonIncomplete"]
    ];
});
_c = LessonNavigation;
var _c;
__turbopack_context__.k.register(_c, "LessonNavigation");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/CommunityButton.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CommunityButton({ className, variant, size }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
        ...
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("bg-emerald-600 hover:bg-emerald-700 text-white gap-2", className),
        variant: variant,
        size: size,
        children: [
...
_s(CommunityButton, "vLS/Pc62NkXT8XSoZHbyIxKvVF8=", false, function() {
    return [
...
_c = CommunityButton;
var _c;
__turbopack_context__.k.register(_c, "CommunityButton");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/CoursePlayerClient.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$CommunityModalContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/context/CommunityModalContext.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useCourse$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useCourse.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$LessonNavigation$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/LessonNavigation.tsx [app-client] (ecmascript)");
...
function CoursePlayerClient({ courseId, user, profile, isEnrolled, children }) {
    ...
    const [desktopSidebarCollapsed, setDesktopSidebarCollapsed] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [userId, setUserId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(user?.id || null);
    const { openCommunity } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$CommunityModalContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCommunityModal"])();
    // LAYER 2 OPTIMIZATION: Use Hooks with Cached Data
    const { data: course, isLoading: courseLoading, error: courseError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useCourse$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCourse"])(courseId);
    const { data: modules, isLoading: modulesLoading, error: modulesError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useLessons$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLessons"])(courseId);
    ...
    const allLessons = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CoursePlayerClient.useMemo[allLessons]": ()=>{
            if (!modules) return [];
            return modules.flatMap({
                "CoursePlayerClient.useMemo[allLessons]": (m)=>m.lessons
            }["CoursePlayerClient.useMemo[allLessons]"]); // Lessons are sorted in the hook
        }
    }["CoursePlayerClient.useMemo[allLessons]"], [
        modules
    ]);
    ...
    const currentLesson = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CoursePlayerClient.useMemo[currentLesson]": ()=>{
            if (!allLessons.length) return null;
            if (lessonIdParam) {
                return allLessons.find({
                    "CoursePlayerClient.useMemo[currentLesson]": (l)=>l.id === lessonIdParam
                }["CoursePlayerClient.useMemo[currentLesson]"]) || null;
            }
    ...
    const { prevLessonId, nextLessonId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CoursePlayerClient.useMemo": ()=>{
            if (!currentLesson || !allLessons.length) return {
                prevLessonId: null,
                nextLessonId: null
            };
            const currentIndex = allLessons.findIndex({
                "CoursePlayerClient.useMemo.currentIndex": (l)=>l.id === currentLesson.id
            }["CoursePlayerClient.useMemo.currentIndex"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CoursePlayerClient.useEffect": ()=>{
            if (!userId) {
                const getUser = {
                    "CoursePlayerClient.useEffect.getUser": async ()=>{
                        const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
                        const { data: { user } } = await supabase.auth.getUser();
                        if (user) {
                            setUserId(user.id);
                ...
                }["CoursePlayerClient.useEffect.getUser"];
                getUser();
            }
        }
    }["CoursePlayerClient.useEffect"], [
    ...
    const progressPercentage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CoursePlayerClient.useMemo[progressPercentage]": ()=>{
            if (!lessonProgress || !allLessons.length) return 0;
            const completedCount = lessonProgress.filter({
                "CoursePlayerClient.useMemo[progressPercentage]": (p)=>p.completed
            }["CoursePlayerClient.useMemo[progressPercentage]"]).length;
    ...
    const { mutate: markComplete } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$student$2f$useLessonProgress$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMarkLessonComplete"])();
    // Show loading state
                ...
                children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$accordion$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AccordionContent"], {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: module.lessons.map((lesson)=>{
                                                        ...
                                                        let Icon = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$book$2d$open$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__BookOpen$3e$__["BookOpen"];
                                                        ...
                                                        if (isLocked) {
                                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("group flex items-start gap-3 py-3 px-4 text-sm transition-all rounded-lg border-l-4 border-transparent text-muted-foreground/50 cursor-not-allowed bg-muted/10"),
                                                                children: [
                                                        ...
                                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ClientSideLink$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClientSideLink"], {
                                                            ...
                                                            lessonId: lesson.id,
                                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("group flex items-start gap-3 py-3 px-4 text-sm transition-all rounded-lg border-l-4", isActive ? "bg-emerald-50 dark:bg-emerald-950/20 border-emerald-500 text-emerald-950 dark:text-emerald-50" : "border-transparent text-muted-foreground hover:bg-muted/50 hover:text-foreground"),
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Icon, {
                                                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("h-5 w-5 shrink-0 mt-0.5", isActive ? "text-emerald-600 dark:text-emerald-400" : "text-muted-foreground/70")
                                                                }, void 0, false, {
                                                                    fileName: "[project]/components/CoursePlayerClient.tsx",
                                                                    lineNumber: 254,
                                                                    columnNumber: 57
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("font-medium line-clamp-2 leading-tight", isActive ? "text-emerald-900 dark:text-emerald-100" : "text-foreground"),
                                                                            children: lesson.title
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/components/CoursePlayerClient.tsx",
                                                                            lineNumber: 259,
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("text-xs mt-1", isActive ? "text-emerald-600/80 dark:text-emerald-400/80" : "text-muted-foreground/60"),
                                                                            children: [
                                                                                typeLabel,
                                                                                " ",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "w-full",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$CommunityButton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CommunityButton"], {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$LessonNavigation$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LessonNavigation"], {
                                            courseId: courseId,
...
_s(CoursePlayerClient, "qIt+aSMUyZnQqT+gTyXU6pRlPmc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$CommunityModalContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCommunityModal"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useCourse$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCourse"],
...
_c = CoursePlayerClient;
var _c;
__turbopack_context__.k.register(_c, "CoursePlayerClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_cb04467f._.js.map