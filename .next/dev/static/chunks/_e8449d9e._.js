...
"[project]/app/(public)/courses/[courseId]/EnrollButton.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    const handleEnroll = async ()=>{
        ...
        try {
            ...
            if (data.url) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Enrolled successfully!");
                router.refresh();
                router.push(`/learn/${courseId}`);
            }
        } catch (error) {
...
_s(EnrollButton, "oofmIDu+Prn0iTOh5nKhCcpj4zQ=", false, function() {
    return [
...
//# sourceMappingURL=_e8449d9e._.js.map